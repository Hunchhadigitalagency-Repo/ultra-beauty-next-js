    ...
    <div className={`lg:w-[400px] ${searchBoxClassName}`}>
      ...
      <div className="relative">
        <Input
          ...
          className={`block w-full min-w-[220px] lg:w-[400px] ${searchBoxClassName} p-4 h-10 text-sm text-textColor bg-white border focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-[#414042] rounded-sm  ${className}  pr-8`}
