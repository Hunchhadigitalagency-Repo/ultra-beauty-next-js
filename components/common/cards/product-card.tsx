  ...
  return (
    <section className="flex flex-col justify-between w-full gap-2 overflow-hidden bg-white rounded-lg md:gap-3 lg:gap-4">
      ...
      <div
        ...
        className="relative mb-2 w-full h-40 sm:h-60 md:h-72 lg:h-[350px] overflow-hidden rounded-lg group cursor-pointer"
      >
        <Image
          src={imageSrc}
          alt={alt}
      ...
      <div className="flex flex-col ">
        ...
        <h3 className="text-base font-medium line-clamp-1 md:text-lg lg:text-xl font-playfair text-foreground">
          {title}
        </h3>
      </div>
