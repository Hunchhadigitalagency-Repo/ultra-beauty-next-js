            ...
            <div className="bg-white w-[400px] h-full shadow-lg p-8 overflow-y-auto animate-slideInRight ml-auto">
                    ...
                    <div className="flex flex-col">
                        <div className="flex gap-3 items-start">
                            ...
                            <div className="flex-1">
                                <h2 className="text-sm font-semibold leading-tight">{data.name}</h2>
                ...
                <div className="space-y-4 text-sm divide-y">
                    ...
                    <div className="flex justify-between py-2">
                        ...
                        <span className={`${data.quantity < 5 ? 'text-red-600' : 'text-green-600'}`}>
                            {data.quantity} units
                        </span>
                    </div>
                            ...
                            {data.variants && data.variants.length > 0 ? (
                                data.variants.map((variant: any, index: number) => (
                                    variant.product_variants?.map((pv: any, pvIndex: number) => (
                                        <div key={`${index}-${pvIndex}`} className="text-[10px] border h-[20px] text-black bg-gray-100 rounded-2xl px-2 py-1 flex justify-center items-center">
                    ...
                    <div className="py-2 flex justify-between">
                        ...
                        <div className="flex gap-2 flex-wrap">
                            <span
                                className={`text-xs px-2 py-1 rounded ${getStatusColor(data.is_published, data.is_Featured)}`}
                            >
                    ...
                    <div className="py-2 flex justify-between">
                        ...
                        <span className={data.is_tax_applicable ? "text-green-600" : "text-gray-500"}>
