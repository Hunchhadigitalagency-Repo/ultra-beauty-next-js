...
const OrderDetailsModal = ({ order, onClose }: Props) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/30 backdrop-blur-sm flex justify-center items-center md:p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl relative p-6 max-h-[90vh] overflow-y-auto">
        <button
        ...
        <div className="flex flex-col md:flex-row md:flex-wrap gap-4 item-center justify-center">
              ...
              >
                ...
                <div className="flex flex-row gap-4 items-center">
                  ...
                  <div className="flex flex-col flex-1 w-full">
                    <div className="flex flex-col flex-1 w-full">
                      <div className="flex gap-2 mb-2 md:block hidden px-4">
                        <Badge
                          variant="outline"
                          className="bg-gray-50 border-gray-200 text-[11px] md:text-sm md:h-[30px] md:w-[150px] w-[80px] rounded-[2px]">
                          Order ID #{data.quantity}
                    ...
                    <div className="flex flex-col md:flex-row gap-4 mb-3">
                      {/* Unit Price */}
                      <div className="gap-2 flex flex-row md:flex-col bg-blue-50 text-blue-800 px-4 py-2 rounded-lg shadow-sm w-full md:w-1/3">
                        <span className="text-xs font-medium">Unit Price: </span>
                        <span className="text-xs font-semibold">NPR {data.unit_price}</span>
                      </div>

                      {/* Total Amount */}
                      <div className="gap-2 flex flex-row md:flex-col flex-col bg-green-50 text-green-800 px-4 py-2 rounded-lg shadow-sm w-full md:w-1/3">
                        <span className="text-xs font-medium">Total Amount: </span>
                        <span className="text-xs font-semibold">NPR {data.total_amount}</span>
                      </div>
                      <Button
