    ...
    },
    {
      ...
      render: (order: OrderResponse) => order?.order_status?.name === "Pending" ? (
        ...
        <div className="text-white">
          <span className="block inline-block px-4 py-2 text-white bg-red-400 rounded-sm">Cancelled</span>
        </div>
      ) : order?.order_status?.name === "Returned" ? (
        <div className="text-white">
          <span className="block inline-block px-4 py-2 text-white bg-orange-400 rounded-sm">Returned</span>
        </div>
      ) : order?.order_status?.name === "Delivered" ? (
        <div className="text-white">
          <span className="block inline-block px-4 py-2 text-white bg-green-400 rounded-sm">Delivered</span>
        </div>
      ) : (
        <div className="text-white">
          <span className="block inline-block px-4 py-2 text-white bg-gray-400 rounded-sm">Unknown Status</span>
        </div>
      )
    },
    {
