...
const OrderHeader: React.FunctionComponent<OrderHeaderDetails> = ({ orderItems }) => {
  ...
  return (
    <section className="shadow rounded-sm">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs md:gap-6 md:text-sm">
          ...
          {order_status?.name && (
            <Button
              ...
              className={`uppercase text-[10px] md:text-sm px-2 md:px-3 py-1.5 ${checkOrderStatus(
          ...
          {!order_status?.name?.toLowerCase().includes("delivered") && (
            <Button
              ...
              className="text-white rounded-sm cursor-pointer uppercase text-[10px] md:text-sm px-2 md:px-3 py-1.5 bg-red-600 text-center"
            >
              Cancel Order
            </Button>
          )}
          ...
          <Button
            ...
            className="text-white rounded-sm cursor-pointer uppercase text-[10px] md:text-sm px-2 md:px-3 py-1.5 bg-orange-500 text-center"
          >
            Track Order
          </Button>
        </div>
