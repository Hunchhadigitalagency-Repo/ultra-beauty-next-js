...
const BrandsSection = () => {
    ...
    return (
        <section className="relative min-h-[150px] md:min-h-[400px] z-30 w-full bg-cover bg-center"
            style={{
                backgroundImage: `url('https://img.freepik.com/premium-photo/dust-explosion-black-background_43379-1040.jpg')`,
            }}>
