...
const CategoryProduct: React.FunctionComponent<CategoryProductProps> = ({
  featuredCategoryId,
  featuredCategory,
}) => {
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <button
          onClick={() => {
            ...
            dispatch(toggleCategory({ id: featuredCategoryId, checked: true }));
          }}
          className={`text-foreground cursor-pointer hover:text-primary text-xs sm:text-sm  transition-all duration-300 ease-in-out flex items-center gap-1 sm:gap-2 whitespace-nowrap uppercase `}
        >
          SHOP NOW
                  ...
                  >
                    <div className="flex w-full h-full">
                      <ProductCard
                        ...
                        isWishlisted={
                          isWishlisted[categoryWiseProduct.slug_name] ??
                          categoryWiseProduct.my_wishlist
                        }
