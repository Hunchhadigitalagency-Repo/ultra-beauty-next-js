  ...
  return (
    <section className='padding'>
      ...
      style={{
        ...
        <SectionHeader titleClassName='text-white text-2xl'
            title="Hi, How can we help?"
            description=""
            className="items-center text-white"/>
            <div className='flex justify-center gap-4 items-center'>
            
                <SearchBox iconClassName='text-white' className='bg-transparent border border-[#FFFFFF] rounded-sm text-white  !placeholder-white  focus-visible:border-white' placeholder ="Search for the topic or question........." />           
