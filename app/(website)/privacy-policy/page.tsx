...
const PrivacyPolicy: React.FC = () => {
  const { data: privacyPolicy, isLoading } = useFetchData<PrivacyPolicy>(
    "/privacy-policy/",
    true
  );
  ...
  let cleanHtml = DOMPurify.sanitize(privacyPolicy?.description || "", {
  ...
  return (
    <section className="space-y-12 px-7 md:px-40 py-10">
      <SectionHeader title="Privacy Policy" description="" titleClassName="text-primary" />
